...
export default function Pricing() {
    return (
        <div className="flex flex-col w-full justify-start items-center mb-8 mt-4 text-primary">
            <h3 className="text-4xl font-bold">Nuestros Paquetes</h3>
            <p>
            Todos nuestros paquetes incluyen un armazón de línea.
            </p>
            <div className="flex w-full justify-center sm:flex-col sm:items-center md:flex-row md:h-[75vh] md:items-start">
